    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">{{__trans('edit_document_type')}}</h3>
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{__trans('edit_document_type')}}</li>
                    </ul>
                </div>
                <div class="col-auto">
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    ...
                    <div class="card-body">
                        <form action="{{route('backend.document-types.update',$documentType)}}" datatable="true"
                            method="POST" class="ajax-form-submit reset" redirect>
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="col-md-10">
                                            ...
                                            <div class="col-md-4 d-flex align-items-center">
                                                <div class="form-check form-switch mb-3" style="margin-top: auto;">
                                                    <input class="form-check-input" type="checkbox" name="user_visible"
                                                        id="user_visible" value="1"
                                                        {{ isset($documentType) && $documentType->user_visible ? 'checked' : '' }}>
                                                    <label class="form-check-label ms-2" for="user_visible">
                                                        {{ __trans('Visible to User') }}
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea style="height: 1200px;"  name="template" id="template"
                                                    id="template">{{$documentType->template}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
