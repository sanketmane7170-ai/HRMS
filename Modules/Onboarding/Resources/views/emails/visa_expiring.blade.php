...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>This is an automated reminder that your <span class="warning">Residence Visa</span> is expiring in <strong>{{ $days }} days</strong>.</p>
            <p>Please coordinate with the PRO/HR department immediately for renewal to avoid legal penalties.</p>
            <center><a href="{{ route('portal.index') }}" class="btn">View My Documents</a></center>
        </div>
        <div class="footer">
