<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">Update Uniform Request - {{ $requestApp->user->name }}</h4>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="{{route('backend.apparel.request.update',$requestApp->id)}}" datatable="true" method="POST" class="ajax-form-submit reset">
            @csrf
