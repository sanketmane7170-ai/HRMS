<div class="modal-dialog ">
    <div class="modal-content">
        ...
        <form action="{{route('backend.apparel.store')}}" datatable="true" method="POST" class="ajax-form-submit reset">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" name="number_of_given" class="form-control" placeholder="Uniform per year">
                        </div>
                    </div>
                </div>
            </div>
