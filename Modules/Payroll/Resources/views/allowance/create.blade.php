<div class="modal-dialog modal-lg" style="max-width: 523px !important;">
    <div class="modal-content">
        ...
        <form action="{{route('backend.payroll.user.user-salaries.storeallowance',$user)}}" datatable="true" method="POST" class="ajax-form-submit reset">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <select name="allowance_type" class="form-control select-search" id="allowance_type">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            <p id="applicableMonthsNote">
                                ...
                                <span style="color: red;">If Checkbox not checked then allowance will be consider for every month.</span>
                            </p>
                        </div>
                    </div>
                    <div class="col-md-12">
