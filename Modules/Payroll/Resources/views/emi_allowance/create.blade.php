<div class="modal-dialog modal-lg" style="max-width: 523px !important;">
    <div class="modal-content">
        ...
        <form action="{{route('backend.payroll.storeEMIAllowance', [$user,$monthyear])}}" datatable="true" method="POST" class="ajax-form-submit reset">
            @csrf
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect waves-light save-emi-allowance">{{__trans('save')}} </button>
            </div>
        </form>
    </div>
</div>
