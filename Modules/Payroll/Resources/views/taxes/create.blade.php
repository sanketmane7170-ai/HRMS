<div class="modal-dialog modal-lg" style="max-width: 523px !important;">
    <div class="modal-content">
        ...
        <form action="{{ route('backend.payroll.employee-taxes.store') }}" datatable="true" method="POST" class="ajax-form-submit reset">
            @csrf
            @method('POST')
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="taxamount" class="form-control" required>
                        </div>
                    </div>
                </div>
            </div>
