...
<div class="modal-dialog modal-lg" style="max-width: 523px !important;">
    <div class="modal-content">
        ...
        <form action="{{ route('backend.payroll.advance-request.store') }}" datatable="true" method="POST" class="ajax-form-submit reset">
            @csrf
            @method('POST')
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <div class="input-container">
                                ...
                                <input type="number" name="loan_months" class"loanmonth" id="numberInput" value="0" min="0" max="12" readonly />
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <select name="type" class="form-control" required>
                                <option value="Salary Advance">Advance Salary</option>
