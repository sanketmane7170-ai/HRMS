<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form action="{{route('backend.employee.addRequest')}}" datatable="true" method="POST" class="ajax-form-submit reset">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="reason" class="form-control" placeholder="{{__trans('add_reason')}}">
                        </div>
                    </div>
                </div>
            </div>
