    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">{{__trans('update_user_increment_letter')}}</h3>
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{__trans('update_user_increment_letter')}}</li>
                    </ul>
                </div>
                <div class="col-auto">
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form action="{{route('backend.user_increment_letter.update',$documentType->id)}}"
                            datatable="true" method="POST" class="ajax-form-submit reset" redirect>
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="user_id" id="user_id" class="form-control select-search">
                                                ...
                                                <option value="{{$user->id}}" @if($documentType->user_id == $user->id)
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="letter_type_id" id="letter_type_id"
                                                ...
                                                <option value="{{$letter->id}}" @if($documentType->letter_type_id ==
                                                    $letter->id) selected @endif >{{$letter->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="salary_increment_amount"
                                                value="{{ $documentType->salary_increment_amount }}"
                                                class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="salary_increment_date"
                                                value="{{ $documentType->date }}" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="user_basic_salary"
                                                value="{{ $documentType->user_basic_salary }}" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="user_transportation_allowances"
                                                value="{{ $documentType->user_transportation_allowances }}" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="user_housing_allowances"
                                                value="{{ $documentType->user_housing_allowances }}"
                                                class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="user_other_allowances"
                                                value="{{ $documentType->user_other_allowances }}" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="user_gross_salary"
                                                value="{{ $documentType->user_gross_salary }}" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="remarks" value="{{ $documentType->remarks }}"
                                                class="form-control" placeholder="{{__trans('remarks')}}">
                                        </div>
                                    </div>
