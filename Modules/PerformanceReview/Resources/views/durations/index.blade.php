    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">{{ __trans('Review Duration List') }}</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{ route('backend.dashboard') }}">{{ __trans('dashboard') }}</a>
                        </li>
                        <li class="breadcrumb-item active">{{ __trans('Review Duration List') }}</li>
                    </ul>
                </div>
                <div class="col-auto">
                    @can('Manage Performance Review')
                        <a href="{{ route('reviewduration.create') }}" class="btn btn-primary me-1 edit-button">
...
<script type="text/javascript">
    var table = $('#dataTable').DataTable({
        ...
        order: [[0, 'desc']],
        ajax: {
            url: "{{ route('reviewduration.index') }}",
        },
        columns: [
