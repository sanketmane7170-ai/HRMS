    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{__trans('import_basic_salary')}}</h4>
                ...
                <div class="modal-body p-4">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                @isset($flag)
                                 <label class="form-label">{{__trans('Upload_excel_file')}} ( <a href="{{route('backend.users.bsexport.excel')}}"> {{__trans('download_employee_list')}}</a> )</label>
                                @endisset
