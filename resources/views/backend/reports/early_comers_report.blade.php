    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">{{__trans('Early Comers Attendance Report')}}</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('backend.reports')}}">{{__trans('Reports')}}</a>
                        </li>
                        <li class="breadcrumb-item active">{{__trans('Early Comers Attendance Report')}}</li>
                    </ul>

                </div>
                {{-- <div class="col-auto">
                    <a href="{{route('backend.reports.early_comers_report_export')}}" class="btn btn-sm btn-success mt-2">
        ...
        <div class="row ">
            ...
            <div class="">
                <form action="{{route('backend.reports.early_comers_report_search')}}" enctype="multipart/form-data" method="POST">
                    @csrf
