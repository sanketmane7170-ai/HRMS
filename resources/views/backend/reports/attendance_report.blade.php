    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">{{__trans('Attendance Report')}}</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('backend.reports')}}">{{__trans('Reports')}}</a>
                        </li>
                        <li class="breadcrumb-item active">{{__trans('Attendance Report')}}</li>
                    </ul>

                </div>

                {{-- <div class="col-auto">
                    <a href="{{route('backend.reports.attendance_report_export')}}" class="btn btn-sm btn-success mt-2">
        ...
        <div class="row ">
            ...
            <div class="">
                <form action="{{route('backend.reports.attendance_report_search')}}" enctype="multipart/form-data" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <input type="text" class="form-control datepicker" name="start_date" placeholder="{{__trans('Start Date')}}" value="{{ isset($start_date) ? $start_date : "" }}">
                                <small class="text-muted">{{__trans('Start Date')}}</small>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
                                <input type="text" class="form-control datepicker" name="end_date" placeholder="{{__trans('End Date')}}" value="{{ isset($end_date) ? $end_date : "" }}">
                                <small class="text-muted">{{__trans('End Date')}}</small>
                            </div>
                        </div>
            <div class="col-sm-2">
                <div class="form-group ">
