                    ...
                    <div class="row align-items-center text-start">
                        ...
                        <div class="col-lg-8">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    <h2 class="mb-3 f-w-600 text-center">404 | Not Found</h2>
                                </div>
                                <div style="text-align:center">
                                    <p class="mb-3 f-w-600 text-center">Sorry this page is not exist </p>
                                </div>
                                <div style="text-align: center;">
                                    <a href="{{url('/')}}" class="btn-primary btn-block login-do-btn btn" style="width: 40% !important;">Go Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2"></div>
